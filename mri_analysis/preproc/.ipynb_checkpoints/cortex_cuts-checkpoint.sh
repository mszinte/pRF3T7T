...
# -----------------------------------------------------------------------------------------
# Goal of the script:
# Run freeview to cut the cortex
# -----------------------------------------------------------------------------------------
# Input(s):
# $1: project directory
...
# -----------------------------------------------------------------------------------------
# Exemple: [to run locally]
# cd ~/disks/meso_H/projects/pRF3T7T/mri_analysis/
# sh preproc/cortex_cuts.sh /scratch/mszinte/data/pRF3T7T sub-01 rh mszinte
# sh preproc/cortex_cuts.sh /scratch/mszinte/data/pRF3T7T sub-01 lh mszinte
# -----------------------------------------------------------------------------------------
